...
Os operadores de atribuição são usados para atribuir um valor a uma variável -> =
...
Existem também operadores de atribuição combinados, que são uma forma abreviada de atribuição -> +=
...
O operador AND (&&) é usado para verificar se duas condições são verdadeiras. Se ambas as condições forem verdadeiras,
o resultado será verdadeiro. Caso contrário, o resultado será falso.
...
Existem dois tipos de operadores de incremento: o operador de pré-incremento (++variavel)
e o operador de pós-incremento (variavel++).

Operador de pré-incremento (++variavel) aumenta o valor da variável em 1 antes de usar a variável em uma expressão.
...
Operador de pós-incremento (variavel++) aumenta o valor da variável em 1 depois de usar a variável em uma expressão.
